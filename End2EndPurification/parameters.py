def parameters():
    ...
    num_node = [i for i in range(100, 2001, 100)]
    purification_at_int_nodes = [False, True]
    """
    fidelity_raw_bellpair = [0.84]
    layer2_target_fidelity = [0.9, 0.99]
    layer3_target_fidelity = [0.9, 0.99]
    layer4_target_fidelity = [0.9, 0.99]
    p_op_int_node = [0.01, 0.001]
    p_mem_int_node = [0.01, 0.001]
    p_op_end_node = [0.01, 0.001]
    p_mem_end_node = [0.01, 0.001]
    num_node = [i for i in range(2, 8)]
    purification_at_int_nodes = [False, True]
    """
